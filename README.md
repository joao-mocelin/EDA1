# Estrutura de Dados I (EDA1002) - UDESC/CCT

Este repositório contém os trabalhos práticos, implementações e relatórios desenvolvidos por mim para a disciplina de **Estrutura de Dados I**.
